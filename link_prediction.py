...
#'dataset_nodes150_alpha0.6_beta0.2_undirected-percentage0.5_opposite-signFalse_negative-edgesFalse_directedTrue.pk',
#'dataset_nodes150_alpha0.6_beta0.2_undirected-percentage0.7_opposite-signFalse_negative-edgesFalse_directedTrue.pk'
#'dataset_nodes500_alpha0.1_beta0.2', 'dataset_nodes500_alpha0.05_beta0.2', 'dataset_nodes500_alpha0.08_beta0.2'
...
'dataset_nodes500_alpha0.2_beta0.2_undirected-percentage0.5_opposite-signFalse_negative-edgesFalse_directedTrue',
'dataset_nodes500_alpha0.2_beta0.2_undirected-percentage0.7_opposite-signFalse_negative-edgesFalse_directedTrue',
'dataset_nodes500_alpha0.2_beta0.2_undirected-percentage0.2_opposite-signFalse_negative-edgesFalse_directedTrue'
             ]:
    for task in [
         'three_class_digraph'
         #'direction', 
